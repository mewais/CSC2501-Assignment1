...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, id_batch, n_ids, embedding_matrix):
        ...
        Returns:
         ...
         - The lookup results in a tensor of shape (B, N, embed_size). Reshape
           ...
           more hints.
        """
        one_hot_id_batch = one_hot_float(id_batch, n_ids)
        lookup_result = torch.matmul(one_hot_id_batch, embedding_matrix)
    ...
    def get_concat_embeddings(self, word_id_batch, tag_id_batch,
        ...
        """
        lu_word_embeddings = self.embedding_lookup(word_id_batch, self.config.n_word_ids, self.word_embeddings)
        lu_tag_embeddings = self.embedding_lookup(tag_id_batch, self.config.n_tag_ids, self.tag_embeddings)
